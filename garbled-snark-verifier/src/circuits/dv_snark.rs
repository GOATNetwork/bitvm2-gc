...
fn test_dv_snark_verifier_circuit() {
    ...
    let commit_p = AffinePointRef {
        x: [
            130, 16, 132, 245, 115, 118, 110, 233, 235, 58, 5, 190, 187, 230, 138, 225, 149, 231,
            32, 45, 41, 29, 94, 89, 248, 158, 54, 19, 86, 0,
        ],
        s: [
            93, 74, 178, 168, 173, 38, 101, 88, 181, 49, 78, 207, 89, 78, 130, 42, 242, 245, 88, 5,
            253, 250, 54, 182, 177, 249, 82, 57, 147, 0,
        ],
    };
    let kzg_k = AffinePointRef {
        x: [
            36, 69, 122, 22, 89, 79, 186, 56, 138, 8, 183, 193, 186, 98, 21, 62, 9, 143, 173, 24,
            89, 195, 126, 73, 241, 118, 71, 103, 223, 0,
        ],
        s: [
            12, 122, 106, 168, 104, 248, 117, 18, 171, 218, 85, 138, 31, 80, 250, 230, 176, 136,
            74, 129, 137, 78, 181, 48, 88, 180, 21, 139, 39, 1,
        ],
    };
    let a0 =
        FrRef::from_str("1858232303623355521215721639157430371979542022979851183514844283900649")
            .unwrap();
    let b0 =
        FrRef::from_str("3045644831070136055562137919853497607898653327126781771795842528553732")
            .unwrap();
